...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function populateDiscordDropdowns(discordData) {
        ...
        const channelSelects = ['channel_id', 'post_war_analysis_channel_id', 'clan_games_channel_id', 'cwl_planner_channel_id', 'donations_channel_id', 'watchlist_alert_channel_id', 'low_performance_channel_id', 'capital_report_channel_id', 'smurf_log_channel_id', 'maintenance_alert_channel_id'];
